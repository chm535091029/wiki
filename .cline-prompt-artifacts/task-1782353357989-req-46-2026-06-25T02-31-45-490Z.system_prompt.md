...
- Use standard Markdown checklist: "- [ ]" for incomplete items and "- [x]" for completed items
...
- The current working directory is `d:\A.python project\wiki` - this is the directory where all the tools will be executed from.
